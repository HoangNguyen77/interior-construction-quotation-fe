...
const TypeRoom = () => {
    ...
    const handleModalCategoryToogleClose = () => {
        setRoomId(0);
        setCategoryId(0);
        setErrorRoomId("");
                        ...
                        {isModalTypeRoomOpen && (
                            <div>
                                ...
                                <div className='w-full flex justify-end mt-3'>
                                    <button className='bg-[#FF0000] px-3 py-2 mr-3 rounded-[5px] text-black'
                                            onClick={handleModalRoomToogleClose}>Đóng
                                    </button>
                            ...
                            <div className='h-[59vh] w-full bg-white shadow1 pt-[50px] px-[50px] rounded-[10px]'>
                                ...
                                <div className='overflow-y-auto h-[44vh] pr-3'>
                                    {roomTypeList.map(roomType => (
                                        <div key={roomType.roomId}
                                             className='grid grid-cols-4 border-t-2 border-[#D9D9D9] py-3 gap-2'>
                                            <div
                                                className='col-span-1 text-black flex flex-col justify-center'>{roomType.roomId}</div>
                                            <div
                                                className='col-span-2 text-black flex flex-col justify-center'>{roomType.roomName}</div>
                                ...
                                <div className='overflow-y-auto h-[44vh] pr-3'>
                                    {categoryList.map(category => (
                                        <div key={category.categoryId}
                                            ...
                                            <div
                                                className='col-span-2 text-black flex flex-col justify-center'>{category.roomName}</div>
                                            <div
                                                className='col-span-2 text-black flex flex-col justify-center'>{category.categoryName}</div>
                                            <div className='col-span-1 text-black flex flex-col justify-center'>
                                                {!isModalProductOpen && (<div className='flex justify-end gap-2'>
                                                        <div onClick={() => handleDeleteCategory(category.categoryId)}>
                                                            <Icon classIcon={faTrashCan} color={"black"} size={"20px"}/>
                                                        </div>
                                                        <div
                                                            onClick={() => handleButtonUpdateCategory(category.categoryId)}>
                                                            <Icon classIcon={faPencil} color={"black"} size={"20px"}/>
                                                        </div>
                                                    </div>
                                                )}
